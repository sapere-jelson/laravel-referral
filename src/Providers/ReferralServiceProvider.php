...
namespace Sapere\LaravelReferral\Providers;
...
class ReferralServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->bind('Sapere\LaravelReferral\Controllers\ReferralController', function ($app) {
            return new \Sapere\LaravelReferral\Controllers\ReferralController();
        });
    }
}
